...
import style from './stockLogo.module.scss';

class StockLogo extends Component {
  render() {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={style.svg} role="img">
